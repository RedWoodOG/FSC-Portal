...
/// EXACT MATCH to Portal app theme
...
class AppPalette {
  // Background Colors
  static const Color deepBlack =
      Color(0xFF121212); // Main application background
  ...
  static const Color portalBlue =
      Color(0xFF0056D2); // Primary brand blue - BUTTONS & ACTIVE STATES
  static const Color portalBlueLight =
      Color(0xFF1E6FE8); // Lighter blue variant for hover
  ...
  static const Color purpleAccent =
      Color(0xFF9C27B0); // Graph icons, purple accents, route lines
  ...
  static const Color borderGrey =
      Color(0xFF2A2A2F); // Subtle borders and dividers
}
...
class AppColors {
  ...
  static const Color background =
      AppPalette.deepBlack; // Main background (#121212)
  ...
  // Aliases for convenience (matching user code expectations)
  ...
  // Border & Divider
  static const Color border = AppPalette.borderGrey; // #2A2A2F
  static const Color divider = AppPalette.borderGrey; // #2A2A2F

  // Status Background Colors (for cards with colored backgrounds)
  static Color successBg =
      AppPalette.successGreen.withValues(alpha: 0.15); // Green background
  static Color infoBg =
      AppPalette.portalBlue.withValues(alpha: 0.15); // Blue background
  static Color errorBg =
      AppPalette.alertRed.withValues(alpha: 0.15); // Red background
  ...
  static const Color pinStartPoint =
      AppPalette.successGreen; // Green for starting points
}
...
class AppLayout {
  ...
  static const EdgeInsets logoPadding =
...
class AppTypography {
  ...
  // Text Styles - Headlines (Material 3 typography scale)
...
class AppAssets {
  ...
  static const String logo =
      'assets/logo.webp'; // Using webp since png doesn't exist
...
// ============================================
// 2026 PREMIUM VISUALS (Glassmorphism & Gradients)
// ============================================

class AppGradients {
  // Subtle Ambient Background - "Deep Ocean"
  ...
  // Primary Action Gradient - "Electric Blue"
...
class AppGlass {
  // Standard Blur Strength
  static const double blurSigma = 10.0;

  // Medium Glass Decoration (Cards)
  ...
  // Active Glass Decoration (Selected Items)
  static BoxDecoration activeDecoration = BoxDecoration(
    color: AppPalette.portalBlue.withValues(alpha: 0.15),
    borderRadius: BorderRadius.circular(AppLayout.radiusMD),
    border: Border.all(
      color: AppPalette.portalBlue.withValues(alpha: 0.3),
      width: 1,
    ),
  );
}
