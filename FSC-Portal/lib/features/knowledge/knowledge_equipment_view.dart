...
class KnowledgeEquipmentView extends StatefulWidget {
  final String equipmentType;

  const KnowledgeEquipmentView({super.key, required this.equipmentType});

  @override
  State<KnowledgeEquipmentView> createState() => _KnowledgeEquipmentViewState();
}

class _KnowledgeEquipmentViewState extends State<KnowledgeEquipmentView> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.equipmentType),
        backgroundColor: Colors.transparent,
        elevation: 0,
      ...
      body: Container(
        ...
        child: StreamBuilder<List<KnowledgeEntry>>(
          stream: context
              .read<AppDatabase>()
              .watchKnowledgeEntriesByEquipment(widget.equipmentType),
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'No entries for ${widget.equipmentType}',
                      style: TextStyle(
                          color: theme.colorScheme.onSurface.withValues(alpha: 0.4),
                          fontSize: 16),
                    ),
